...
public class PhoneBookView {
	...
	public static String IDLE_Q = "Please enter your choice of action, \"" + PhoneBookController.ADD_COMMAND + "\" to add a phone entry or \"" + PhoneBookController.SEARCH_COMMAND + "\" to search for a phone number or \"" + PhoneBookController.QUIT_COMMAND + "\" to end the application.";
	public static String SEARCH_RESULT_Q = " - This is the located phone number. Enter \"" + PhoneBookController.START_COMMAND + "\" to do more with the application or \"" + PhoneBookController.QUIT_COMMAND + "\" to end the application.";
	public static String SEARCH_NOT_FOUND_Q = " Phone number not found. Enter \"" + PhoneBookController.START_COMMAND + "\" to do more with the application or \"" + PhoneBookController.QUIT_COMMAND + "\" to end the application.";
	public static String ERROR_Q = "You've entered an invalid choice. Enter \"" + PhoneBookController.START_COMMAND + "\" to do more with the application or \"" + PhoneBookController.QUIT_COMMAND + "\" to end the application.";
